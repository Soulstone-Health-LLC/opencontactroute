...
export default function AudienceFormPage() {
  ...
  useEffect(() => {
    ...
    getAudience(id)
      ...
      .catch(() => setLoadError("Failed to load audience."))
  ...
  async function handleSubmit(e) {
    ...
    try {
      if (isEditing) {
        await updateAudience(id, payload);
      ...
      setSaveError(err.response?.data?.message ?? "Failed to save audience.");
    } finally {
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="mb-0">{isEditing ? "Edit Audience" : "New Audience"}</h2>
        <Link
          to="/admin/audiences"
        ...
        <div className="card-body" style={{ maxWidth: 640 }}>
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="d-flex gap-2">
              ...
              <Link to="/admin/audiences" className="btn btn-outline-secondary">
                Cancel
              </Link>
            </div>
          </form>
