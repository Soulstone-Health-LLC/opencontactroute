  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="mb-0">{isEditing ? "Edit Plan" : "New Plan"}</h2>
        <Link to="/admin/plans" className="btn btn-outline-secondary btn-sm">
          Cancel
        </Link>
      </div>
        ...
        <div className="card-body" style={{ maxWidth: 640 }}>
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="d-flex gap-2">
              ...
              <Link to="/admin/plans" className="btn btn-outline-secondary">
                Cancel
              </Link>
            </div>
          </form>
